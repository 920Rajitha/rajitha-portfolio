...
function Projects() {
  ...
  return (
    <div className="ml-24 bg-gray-100 min-h-screen py-16 px-6">
          ...
          <div className="p-8 space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              {["Flutter", "AI", "Firebase"].map((t, i) => (
                <span key={i} className="bg-gray-100 px-3 py-1 text-sm rounded-md">
                  {t}
                </span>
              ))}
            </div>
            ...
            <div className="flex gap-3 pt-4">
              <a href="#" className="flex items-center gap-2 border px-4 py-2 rounded-md hover:bg-gray-100">
                <FaGithub /> Code
              </a>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <a href="#" className="text-sm border px-3 py-1 rounded-md hover:bg-gray-100">
                    Code
                  </a>
                  <a href="#" className="text-sm bg-black text-white px-3 py-1 rounded-md hover:bg-gray-800">
                    Live
                  </a>
                </div>
